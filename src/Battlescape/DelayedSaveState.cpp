 ...
 * Very simple state, runs interference between the autosave and the screen
 * clearing on the "new turn" screen. This all happens before panic is handled,
 * and forces the text to be rendered over the battlescape rather than the
 * "next turn" screen.
 */
