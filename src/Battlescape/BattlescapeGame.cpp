...
/**
 * This is a very important function. It is called by a BattleState (walking, projectile is flying,
 * explosions,...) at the moment this state has finished its action.
