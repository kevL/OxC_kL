...
void Ruleset::sortLists()
{
	...
	for (std::vector<std::string>::const_iterator
			i = _craftWeaponsIndex.begin();
			i != _craftWeaponsIndex.end();
			++i)
	{
	...
	for (std::vector<std::string>::const_iterator
			i = _ufopaediaIndex.begin();
			i != _ufopaediaIndex.end();
			++i)
	{
	...
	for (std::vector<std::string>::const_iterator
			i = _manufactureIndex.begin();
			i != _manufactureIndex.end();
			++i)
	{
